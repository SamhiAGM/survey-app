  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto py-8">
      <div className="flex flex-col gap-2">
        ...
        >
          Manage and create reusable forms and survey templates.
        </motion.p>
      </div>
      ...
      >
        ...
        <div className="p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
          ...
          <p className="text-slate-400 max-w-md mb-8">
            The Survey Templates feature is currently being built by our engineering team. It will be available in the next release cycle.
          </p>
          <Link 
            href="/dashboard"
